...
1. Growing the semantics out of lots of tokens and a differential testing
   harness that compares against actual CRuby, version 4.0.5.
...
This phase was where both the agents and I met difficulty. As noted above, I
...
First and foremost, the learnings from the first two attempts culminated in a
...
me to scrap the first attempt at modeling a type system for Ruby and proving it
