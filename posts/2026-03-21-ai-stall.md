...
create a remarkably improved standard of living, where humans can be free of
most material constraints and return to a state of creativity and
community-oriented living. The transitional period might be painful, but I am
generally optimistic about what a fully AI-driven future could look like. We can
maximize our chances of success if we pair a push for powerful AI-driven job
automation with
...
become a moat. A good example of this is Cursor. They leveraged their data moat
to build in-house models that are domain-specific for coding and far less
expensive to run. If capital runs out, labs like OpenAI and Anthropic will have
to either cut costs or significantly increase the cost of using their products,
restricting the accessibility of powerful AI. If only mediocre AI remains
accessible, we will settle into a
[stationary point](https://en.wikipedia.org/wiki/Stationary_point) of productive
capacity where humans remain the bottleneck.
