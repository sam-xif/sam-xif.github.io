...
Electricity generation equipment and raw fossil fuels make for two unstable
inputs to the energy equation. Another part of the AI buildout with significant
supply chain risk is silicon. TSMC is a Taiwanese corporation which represents a
single point of failure for the US tech industry. In Q2 2025, TSMC
...
usage. When you purchase electricity, you are charged by kilowatt-hour for
example.

Importantly, if it hasn't yet been made clear, usage-based services businesses
have very different margin profiles than SaaS businesses. And research and
compute costs to train each successive frontier mode have only been going up.
Margins may be improving for worse models, but the training and serving of
frontier models that keeps their business afloat is precisely what’s destroying
their changes at profitability. According to Epoch, the cost of training has
been doubling every 8 months. The cost of compute has not been halving every 8
months. This is, until the costs of inference spike to cover COGS as well as
R&D, or some other business structure gets figured out. Perhaps the government
needs to step in to find R&D.
